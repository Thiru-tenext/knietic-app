...
export function Hero() {
  return (
    <section className="relative pt-32 pb-24 lg:pt-56 lg:pb-56 overflow-hidden bg-mirage-black">
      ...
      <div className="clean-container relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-6 mb-16 px-6 py-3 bg-white/[0.03] border border-white/10 rounded-full backdrop-blur-2xl reveal animate-float-gentle">
          ...
          <h1 className="text-7xl md:text-9xl lg:text-[9.5rem] font-black tracking-tighter text-white mb-16 leading-[0.85] reveal">
            Synthesize <br />
            <span className="text-mirage-gradient">Motion Graphics.</span>
          </h1>

          <p className="text-2xl md:text-4xl text-slate-400 mb-20 max-w-4xl mx-auto leading-tight font-bold reveal">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-10 reveal">
            <Link href="/studio" className="btn-mirage-primary shadow-glow-lime">
              Launch Master Studio <ArrowRight className="w-8 h-8 ml-1" />
            </Link>
